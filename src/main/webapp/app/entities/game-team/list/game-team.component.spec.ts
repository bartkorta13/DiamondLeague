...
import { sampleWithRequiredData } from '../game-team.test-samples';
...
describe('GameTeam Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.gameTeams()[0]).toEqual(expect.objectContaining({ id: 31247 }));
  });

  describe('trackId', () => {
    it('Should forward to gameTeamService', () => {
      const entity = { id: 31247 };
      jest.spyOn(service, 'getGameTeamIdentifier');
      const id = comp.trackId(entity);
      expect(service.getGameTeamIdentifier).toHaveBeenCalledWith(entity);
