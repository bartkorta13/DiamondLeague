...
import { sampleWithRequiredData } from '../stadium.test-samples';
...
describe('Stadium Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.stadiums()[0]).toEqual(expect.objectContaining({ id: 27995 }));
  });

  describe('trackId', () => {
    it('Should forward to stadiumService', () => {
      const entity = { id: 27995 };
      jest.spyOn(service, 'getStadiumIdentifier');
      const id = comp.trackId(entity);
      expect(service.getStadiumIdentifier).toHaveBeenCalledWith(entity);
