...
export class PlayerComponent implements OnInit {
  ...
  trackId = (item: IPlayer): number => this.playerService.getPlayerIdentifier(item);
      ...
      .pipe(
        ...
        tap(() => {
          if (this.players().length === 0) {
            ...
            this.players.set(this.refineData(this.players()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.players.set(this.refineData(dataFromBody));
  }
